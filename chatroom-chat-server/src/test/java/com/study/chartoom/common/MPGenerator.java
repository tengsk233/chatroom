package com.study.chartoom.common;
...
public class MPGenerator {
    public static void main(String[] args) {
        ...
        //设置作者名字
        globalConfig.setAuthor("<a href=\"https://github.com/tengsk233\">study</a>");
        ...
        packageConfig.setParent("com.study.chatroom.common.user");//自定义包的路径
...
//        strategyConfig.setTableFillList(list);
    ...
    public static void assembleDev(DataSourceConfig dataSourceConfig) {
        ...
        dataSourceConfig.setUrl("jdbc:mysql://152.136.58.94:3306/chatroom?useUnicode=true&characterEncoding=utf-8&useSSL=true&serverTimezone=UTC");
    }
}